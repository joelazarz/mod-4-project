...
task1 = Task.create(name: "task-1-name", description:"project description", category:"todo", project_id:1)
task2 = Task.create(name: "task-2-name", description:"project description", category:"wip", project_id:2)
task3 = Task.create(name: "task-3-name", description:"project description", category:"wip", project_id:1)
task4 = Task.create(name: "task-4-name", description:"project description", category:"complete", project_id:2)
